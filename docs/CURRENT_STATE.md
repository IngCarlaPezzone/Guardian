...
La validación confirmó el flujo de las ayudas y los textos dinámicos locales. La RC `0.4.3-rc` está registrada sólo en STG y queda pendiente de la validación integral de RC, incluido el updater. Esta feature está integrada en `main` y no fue desplegada en PROD.
