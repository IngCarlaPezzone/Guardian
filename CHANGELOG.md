...
- Validada manualmente en STG con la prerelease `0.4.3-staging-comprehension-help.6` e integrada en `main`; pendiente de RC y promoción. No está publicada en PROD.
